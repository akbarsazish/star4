...
SELECT * FROM (
    ...
    public function myCalendar(){
        ...
        $todayDate=Carbon::now()->format('Y-m-d');
        return view ("admin.calendar",['commenDates'=>$workList,'month'=>$month,'year'=>$year,'employies'=>$employies,'adminId'=>$adminId,'customers'=>$customers,'cities'=>$cities,'eachdays'=>$eachdays,'admins'=>$admins,'mantagheh'=>$mantagheh,'phoeCodes'=>$phoeCodes,'todayDate'=>$todayDate]);
    }
